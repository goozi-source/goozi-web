        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Goozi Order`</p>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">#<?= $_GET['order']; ?></h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php 
                                            $items = getWhere('requests', 'batch', '=', $_GET['order']);
                                            $errands = getWhere('requestStatus', 'batch', '=', $_GET['order']);
                                            $errand = array_shift($errands);
